...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    private static final BeanPropertyRowMapper ROW_MAPPER = BeanPropertyRowMapper.newInstance(UserMeal.class);
    ...
    public UserMeal save(UserMeal UserMeal, int userId) {
        ...
        if (UserMeal.isNew()){
            ...
            if (namedParameterJdbcTemplate.update("UPDATE meals SET date_time=:date_time, " +
                    "description=:description, calories=:calories WHERE id=:id AND user_id=:user_id",mapSqlParameterSource)==0){
                return null;
            }
        }
